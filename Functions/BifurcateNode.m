function [Tree,n1,n2] = BifurcateNode(Tree,node,Dataset,MaxFeatures,K)

DatasetSplit=BuildReducedDataset(Dataset,Tree.get(node).split);
[split, featuresAccuracy,featuresAccuracyPlus,featuresAccuracyMinus,ResultingCentroids] = PowerSetDatasetDivision2(DatasetSplit,MaxFeatures,K);
